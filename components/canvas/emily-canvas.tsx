...
const EmilyCanvas: FC<EmilyCanvasProps> = ({
  ...
  useEffect(() => {
    ...
    const onPointerMove = (e: PointerEvent | MouseEvent) => {
      if (!mount) return;
      // User interaction ends shimmer immediately
      if (shimmerPhase !== "complete") {
        shimmerPhase = "complete";
      }
    ...
    const update = () => {
      ...
      if (loadTime === 0) {
        ...
        // Initialize shimmer start position
