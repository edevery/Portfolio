...
export const workItems: WorkItem[] = [
  ...
  },
  {
    ...
    slug: "incase",
    title: "Incase",
    description: "One secure place to store and share the information that matters most.",
    categories: ["product", "identity"],
    displayTags: ["Web", "Identity", "Motion"],
    image: "/Thumbnails/Desktop/Incase.png",
    mobileImage: "/Thumbnails/Mobile/Incase.png",
    heroMedia: {
      type: "image",
      src: "/Work/Incase/open-case.png",
      poster: "/Thumbnails/Desktop/Incase.png",
    },
    accentColor: "#005679",
    logo: "/Work/Incase/Icon.png",
    logoClassName: "h-24 md:h-32 lg:h-40 !aspect-square",
    role: "Brand & Product Designer",
    context: "A four-week sprint building Incase's foundational visual language for launch.",
    sections: [
      {
        id: "role",
        label: "Role",
